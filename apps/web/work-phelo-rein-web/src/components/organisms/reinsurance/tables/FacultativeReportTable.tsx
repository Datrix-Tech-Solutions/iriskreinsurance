...
const CEDANT_SCOPE_COLUMNS: ReportColumn[] = [
  ...
  rightAmount('cedantCommissionAmount', 'Cedant Commission', (row) => fac(row).cedantCommissionAmount, '100px'),
  rightAmount('netPremiumDueIrisk', 'Net Premium Due iRisk', (row) => fac(row).netPremiumDueIrisk, '100px'),
  rightAmount(
...
const REINSURER_SCOPE_COLUMNS: ReportColumn[] = [
  ...
  rightAmount('paidFacPremium', 'Paid Fac Premium', (row) => re(row)?.paidFacPremium ?? null, '100px'),
  ...
  rightAmount('netPremiumPaid', 'Net Premium Paid', (row) => re(row)?.netPremiumPaid ?? null, '120px'),
  OFFER_STATUS_COLUMN,
